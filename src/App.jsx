...
function App() {
  return (
    <>
    <div className="flex flex-col-reverse lg:flex-row bg-gradient-to-b from-gray-100 to-white px-4 md:px-8 lg:px-16 py-8 xl:px-52">
      <div className="container mt-5 lg:mt-20 lg:pr-16">
      ...
      <div className="container lg:pl-16">
        <div className="relative h-screen/3 md:h-screen/2 lg:h-screen/2">
          <img
    ...
    <div className="flex flex-col lg:flex-row px-4 lg:px-16 md:px-8 xl:px-52">
