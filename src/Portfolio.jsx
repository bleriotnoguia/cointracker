    ...
    <>
      <div className="bg-gradient-to-b from-gray-100 via-white to-gray-100">
        <div className="container md:w-2/3 xl:w-1/2 flex flex-col md:flex-row justify-between items-center mx-auto px-4 py-4">
          ...
          >
            <button
              className="px-5 py-3 inline-block bg-blue-600 text-white font-bold rounded-md min-w-max"
              onClick={() => alertRef.current.openModal()}
            >
              + Add new coin
            </button>
            <button
              className="px-5 py-3 mt-2 bg-blue-600 text-white font-bold rounded-md min-w-max flex items-center"
              onClick={() => updateCoins()}
            >
